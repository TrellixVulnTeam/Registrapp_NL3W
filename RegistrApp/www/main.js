(self["webpackChunkclase3"] = self["webpackChunkclase3"] || []).push([["main"],{
...
const routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: '',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_contactos_contactos_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./contactos/contactos.module */ 5593)).then(m => m.ContactosPageModule)
            },
            {
                path: ':contactoId',
                loadChildren: () => __webpack_require__.e(/*! import() */ "common").then(__webpack_require__.bind(__webpack_require__, /*! ./contactos/detalle-contacto/detalle-contacto.module */ 9313)).then(m => m.DetalleContactoPageModule)
            },
            {
                path: 'asistencia-manual',
                loadChildren: () => __webpack_require__.e(/*! import() */ "common").then(__webpack_require__.bind(__webpack_require__, /*! ./contactos/asistencia-manual/asistencia-manual.module */ 907)).then(m => m.AsistenciaManualPageModule)
            }
        ]
    },
    {
    ...
    {
        path: 'signup',
        loadChildren: () => __webpack_require__.e(/*! import() */ "common").then(__webpack_require__.bind(__webpack_require__, /*! ./login/signup/signup.module */ 5980)).then(m => m.SignupPageModule)
    },
];
