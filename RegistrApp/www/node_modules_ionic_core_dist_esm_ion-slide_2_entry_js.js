...
const Slides = class {
  ...
  connectedCallback() {
    ...
    if (typeof MutationObserver !== 'undefined') {
      ...
      (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.el, () => {
        if (!this.didInit) {
          this.didInit = true;
          this.initSwiper();
        }
  ...
  initSwiper() {
    ...
    return (0,D_Duoc_UC_2_a_o_2_semestre_Programacion_app_movil_RegistrApp_v3_Registrapp_RegistrApp_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const {
        Swiper
      } = yield __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_swiper_bundle-6c5e7804_js").then(__webpack_require__.bind(__webpack_require__, /*! ./swiper.bundle-6c5e7804.js */ 2159));
...
const waitForSlides = el => {
  return Promise.all(Array.from(el.querySelectorAll('ion-slide')).map(s => new Promise(resolve => (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.c)(s, resolve))));
};
